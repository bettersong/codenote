...
![你的 git-practice 和「同事」的 git-practice-another](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="274" height="153"></svg>)你的 git-practice 和「同事」的 git-practice-another
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="421" height="298"></svg>)
...
![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="299" height="87"></svg>)





![嗯，「女装」](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="312" height="105"></svg>)嗯，「女装」
...
![记得填写提交信息](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="489" height="170"></svg>)记得填写提交信息
...
![GitHub 上已经能看到刚更新的文件](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1010" height="299"></svg>)GitHub 上已经能看到刚更新的文件
...
![用 git pull 把代码从远程仓库取下来](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="431" height="239"></svg>)用 git pull 把代码从远程仓库取下来
...
![push 被拒绝](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="598" height="153"></svg>)push 被拒绝
...
![img](https://user-gold-cdn.xitu.io/2017/11/20/15fd77967acc6821?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![push 成功](https://user-gold-cdn.xitu.io/2017/11/30/1600a786d9ac2cc5?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)push 成功
